...
ENV DJANGO_SETTINGS_MODULE=portfolio.settings.production DJANGO_DEBUG=off

# Tell uWSGI where to find your wsgi file:
ENV UWSGI_WSGI_FILE=portfolio/wsgi.py
...
ENV UWSGI_STATIC_MAP="/media/=/code/portfolio/media/"
...
RUN mkdir -p /code/portfolio/media/images && chown -R 1000:2000 /code/portfolio/media

# mark the destination for images as a volume
VOLUME ["/code/portfolio/media/images/"]
